...
function openConfirmNICKNAME(infoform){         
   var nickname=infoform.member_nickname.value;
   var url="./MypageNICKNAMECheckAction.me?member_nickname="+infoform.member_nickname.value;
...
function out(){
   ...
   var password = prompt("비밀번호를 입력해주세요.");
       if (Answer == true){ 
       location.href = "./MypageDeleteAction.my?member_email=<%=vo.getMember_email()%>&member_password=" + password;
    }
 }
</script>
...
<form enctype='multipart/form-data' action="./MypageUpdateAction.my" method="post" name="infoform" onsubmit="return infocheck()">

<thead>
	<tr><td class="top_head" colspan="2"><h3>회원정보수정</h3><h6>&nbsp;&nbsp;Project Altaltal 본인 회원 정보를 수정할 수 있습니다.</h6></td></tr>
</thead>
...
<button type="button" class="button" name="delete" onclick="out()">회원 탈퇴</button>
</td>
</tr>
</tfoot>
</form>
