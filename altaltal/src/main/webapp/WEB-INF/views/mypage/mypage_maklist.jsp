...
%>
	...
	%>
			<tr>
				...
				<td align='center'><%=makguliList.get(i).getMakguli_area() %></td>
				<td align='center'><%=makguliList.get(i).getMakguli_make() %></td>
				<td align='center'><%=makguliList.get(i).getMakguli_name() %></td>
				<td><button class="write" onclick="location.href='getMakguli.ma?makguli_num=<%=makguliList.get(i).getMakguli_num()%>';">막걸리 상세</button>
	...
	<div class="container">
          <form class="form-inline" action="./mypageMakguliList.ma" method="POST" onsubmit="return searchCheck();" >
              <center>
	...
	<ul class="pagination">
		...
		<li><a>«</a></li>&nbsp;
		<%}else{ %>
		<li><a href="mypageMakguliList.ma?page=<%=nowPage-1 %>&keyword=<%=keyword%>&topic=<%=topic%>">«</a></li>&nbsp;
		<%} %>
		...
		<li><a><%=a %></a></li>
		<%}else{ %>
		<li><a href="mypageMakguliList.ma?page=<%=a %>&keyword=<%=keyword%>&topic=<%=topic%>"><%=a %>
		</a></li>&nbsp;
		<%} %>
		<%} %>
