...
%>
			...
			<br/>
            <div class="col-md-4">
                <div id="map" class="map-travelList"></div>
<%
     	for(int i=0; i<courseList.size(); i++){
%>	
...
%>	
			...
			inforWindows[<%=i%>] = new google.maps.InfoWindow({
					content: '<div id="<%=siteList.get(i).getSite_name() %>" class="carousel slide" data-ride="carousel"><ol class="carousel-indicators">'
					+ '<li data-target="#<%=siteList.get(i).getSite_name()  %>" data-slide-to="0" class="active"></li> <li data-target="#myCarousel" data-slide-to="1"></li>'
					+ '<li data-target="#<%=siteList.get(i).getSite_name()  %>" data-slide-to="2"></li></ol><div class="carousel-inner">'
					+ '<div class="item active"><img class="img-travel" src="/altaltal/image/site/<%=siteList.get(i).getSite_picture()  %>" width="200" height="200" /></div>'
					+ '</div>'
					+ '<a class="left carousel-control" href="#<%=siteList.get(i).getSite_name() %>" data-slide="prev">'
					+ '<span class="glyphicon glyphicon-chevron-left"></span><span class="sr-only">Previous</span></a>'
					+ '<a class="right carousel-control" href="#<%=siteList.get(i).getSite_name() %>" data-slide="next">'
